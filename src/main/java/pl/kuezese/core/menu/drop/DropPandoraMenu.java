...
public class DropPandoraMenu {

    private final CorePlugin core;

    public void open(Player p) {
        Inventory inv = this.core.getServer().createInventory(p, 45, ChatHelper.color("&8>> &aDrop z Pandory &8<<"));
        int[] allowed = { 10, 11, 12, 13, 14, 15, 16, 19, 20, 21, 22, 23, 24, 25, 28, 29, 30, 31, 32, 33, 34, 37, 38, 39, 40, 41, 42, 43, 44 };

        List<CaseItem> get = this.core.getPandoraManager().getItems();

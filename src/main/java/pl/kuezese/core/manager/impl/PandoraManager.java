...
@Getter
public class PandoraManager extends Manager {
    ...
    private void load() {
        File file = new File(this.core.getDataFolder(), "pandora.yml");

        if (!file.exists()) this.core.saveResource("pandora.yml", true);
